    ...
    <footer className="bg-[#0B0B0B] border-t border-[#262B33] py-16" data-testid="footer">
      <div className="max-w-[1200px] mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-[#F5F7FA] font-medium mb-4 font-saira">Quick Links</h3>
            <ul className="space-y-2">
              <li><Link to="/about" className="text-[#8B95A5] text-sm hover:text-[#1F6FEB] transition-colors duration-300 font-quicksand">About Us</Link></li>
              <li><Link to="/events" className="text-[#8B95A5] text-sm hover:text-[#1F6FEB] transition-colors duration-300 font-quicksand">Events</Link></li>
              <li><Link to="/team" className="text-[#8B95A5] text-sm hover:text-[#1F6FEB] transition-colors duration-300 font-quicksand">Team</Link></li>
              <li><Link to="/contact" className="text-[#8B95A5] text-sm hover:text-[#1F6FEB] transition-colors duration-300 font-quicksand">Contact</Link></li>
            </ul>
          </div>

          {/* Resources */}
          <div>
            <h3 className="text-[#F5F7FA] font-medium mb-4 font-saira">Resources</h3>
            <ul className="space-y-2">
          ...
          {/* Contact Info */}
          <div>
            <h3 className="text-[#F5F7FA] font-medium mb-4 font-saira">Contact</h3>
        ...
        {/* Bottom Bar */}
        <div className="pt-8 border-t border-[#262B33] ">
          <p className="text-[#8B95A5] text-sm text-center">
